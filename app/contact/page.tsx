            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg ring ring-green/20 bg-sandwhite px-4 py-2.5 text-sm text-gray-900 placeholder:text-gray-900/70 focus:outline-none focus:ring-2 focus:ring-nature"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full rounded-lg ring ring-green/20 bg-sandwhite px-4 py-2.5 text-sm text-gray-900 placeholder:text-gray-900/70 focus:outline-none focus:ring-2 focus:ring-nature resize-none"
                />
              </div>
              ...
              <button
                type="submit"
                className="inline-flex items-center justify-center gap-2 whitespace-nowrap font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body bg-green text-sandwhite shadow-md hover:bg-green/70 hover:shadow-lg h-11 rounded-md px-8 text-base w-full"
              >
